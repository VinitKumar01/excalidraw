...
export const userSchema = z.object({
  ...
  password: z
    ...
    .trim(),
  slug: z
    .string({ required_error: "Room name must be provided" })
    .min(3, { message: "Room name must be 3 letters or more" })
    .max(20, { message: "Room name must be less than 20 characters" })
    .regex(/^[a-zA-Z0-9_]+$/, {
